...
async function initializeAboutPage() {
    ...
    await Promise.all([
        ...
        loadComponent(
            "aboutHeroContainer",
            "components/about-hero.html"
        ),

        loadComponent(
            "aboutMissionContainer",
            "components/about-mission.html"
        ),

        loadComponent(
            "aboutPrinciplesContainer",
            "components/about-principles.html"
        ),

        loadComponent(
            "aboutMethodologyContainer",
            "components/about-methodology.html"
        ),
